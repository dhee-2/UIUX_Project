      ...
      body: Container(
        ...
        child: ListView(
          children: [
            customAppBar(),
            /////////////////////////////////
            Image.asset('assets/hotel1.png', width: 200, height: 200,),
            ////////////////////////////////
            Padding(
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemCount: hotel_picture.length,
                  itemBuilder: (context, index) =>
                      Padding(
                        padding: EdgeInsets.only(left: index  == 0 ? 30: 0),
                        child: hotDestinationCard(hotel_picture[index]['imagePath'], hotel_picture[index]['placeName'], hotel_picture[index]['placeCount'], context ),
                      )
              ),
            ),
            Padding(
    ...
    return GestureDetector(
      onTap: () => {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => DestinationDetail4(imagePath)))
      },
