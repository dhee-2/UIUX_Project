    ...
    return Scaffold(
      floatingActionButton: Container(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                  icon: Icon(Icons.map, color: Colors.white, size: 40,),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Home()),);},),
              IconButton(
                icon: Icon(Icons.restaurant, color: AppColor.primaryColor, size: 40,),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Restaurant()),);},),
              IconButton(
                  icon: Icon(Icons.local_hotel, color: AppColor.primaryColor, size: 40,),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Hotel()),);},),
              IconButton(
                  icon: Icon(Icons.workspace_premium, color: AppColor.primaryColor, size: 40,),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Hotplace()),);},),
              IconButton(
                icon: Icon(Icons.directions_car, color: AppColor.primaryColor, size: 40,),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Rentcar()),);},),
              IconButton(
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            customAppBar(),
            Image.asset('assets/tour_1.png', width: 200, height: 200,),
            Padding(
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: home_picture.length,
                itemBuilder: (context, index) =>
                  Padding(
                    padding: EdgeInsets.only(left: index  == 0 ? 30: 0),
                    child: hotDestinationCard(home_picture[index]['imagePath'], home_picture[index]['placeName'], home_picture[index]['placeCount'], context ),
                  )
              ),
            ),
            Padding(
