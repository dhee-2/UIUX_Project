              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      Padding(
                        ...
                        child: hotDestinationCard(restaurant_picture[index]['imagePath'], restaurant_picture[index]['placeName'], restaurant_picture[index]['placeCount'], context ),
                      )
              ),
            ),
            Padding(
    ...
    return GestureDetector(
      onTap: () => {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => DestinationDetail3(imagePath)))
      },
